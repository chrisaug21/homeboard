...
3. **To-do List** — shared household tasks with open count and next-up summary
   Display-only completions trigger one of seven built-in celebration animations before the card clears; animations use plain CSS/JS with no external library

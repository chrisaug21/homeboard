...
- The display footer nav active fill must use the exact same color source as the footer Homeboard label text (`color: var(--amber)` here), never a hardcoded hex color, and it must resolve correctly in Warm, Dark, and Slate

...
- The display footer nav active fill must always use the active theme token (`var(--amber)` here), never a hardcoded hex color, so Warm, Dark, and Slate all inherit the correct accent

...
- The footer logo should stay scheme-aware: Warm can use a subtle `brightness(0.97)`, Slate should use no filter, and Dark should apply a warm gold CSS filter so the logo reads tonal against the dark background

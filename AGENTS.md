...
- The display footer nav active fill must use the exact same color source as the footer Homeboard label text (`color: var(--amber)` in this app), never a hardcoded hex value, and it must resolve correctly in Warm, Dark, and Slate
